<footer class="bg-gray-50" aria-labelledby="footerHeading">
  ...
  <div class="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      ...
      <div class="mt-12 xl:mt-0">
          ...
          <p class="mt-4 text-base text-gray-500">
            Get the lastest update on development and the release date.
          </p>
          <form class="mt-4 sm:flex sm:max-w-md">
            <label for="emailAddress" class="sr-only">Email address</label>
            <input type="email" name="emailAddress" id="emailAddress" autocomplete="email" required class="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:placeholder-gray-400" placeholder="Enter your email"></input>
    ...
    <div class="mt-12 border-t border-gray-900 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
      <div class="flex space-x-6 md:order-2">
          <a href="https://www.facebook.com/Zeitplans" target="top" class="text-gray-400 hover:text-gray-500">
          ...
          <a href="https://www.instagram.com/zeitplans/" target="top" class="text-gray-400 hover:text-gray-500">
        ...
        <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
          &copy; 2021 Zeitplans.com All rights reserved.
        </p>
    </div>
  </div>
  </footer>